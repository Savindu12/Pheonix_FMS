  ...
  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-lg">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-3xl leading-6 font-medium text-gray-900">Admin Information</h3>
        <p className="mt-5 max-w-3xl text-lg text-gray-500">Personal details of Admin.</p>
      </div>
